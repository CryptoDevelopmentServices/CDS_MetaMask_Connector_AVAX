...
<html lang="en">
  <head>
    ...
    <meta property="og:description" content="CDS stands for Crypto Development Services, This Connector Adds the AVAX mainnet to metamask if you don't already have it along with Crypto Development Services and logo" />
              ...
              <div class="tm-section-wrap">
                <section id="intro" class="tm-section">
                    <div class="tm-bg-grey-transparent tm-intro">
                      <h2 class="tm-section-title mb-5 text-uppercase tm-color-primary">Get connected to the Avalanche Network and add Crypto Development Services</h2>
                        <ul class="list-steps">
